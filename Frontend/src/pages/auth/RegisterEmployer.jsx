...
const RegisterEmployer = () => {
    ...
    return (
        <>
            ...
            >
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Register as Employer</h2>
                <p className="text-gray-600 mb-8">Create an account to start posting jobs and finding talent</p>
